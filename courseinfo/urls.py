...
from courseinfo.views import (
    ...
    RegistrationDetail, InstructorCreate, SectionCreate, CourseCreate, SemesterCreate, StudentCreate,
    RegistrationCreate, InstructorUpdate, SectionUpdate, CourseUpdate, SemesterUpdate, StudentUpdate,
    RegistrationUpdate, RegistrationDelete, InstructorDelete, SectionDelete, CourseDelete, SemesterDelete, StudentDelete
)
